...
public class HorseApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Horse {
    ...
    public class Remove extends HorseApiRequest<com.sporthorsetech.www.horseApi.model.Horse> {
      ...
      protected Remove(java.lang.Long id) {
        super(HorseApi.this, "DELETE", REST_PATH, null, com.sporthorsetech.www.horseApi.model.Horse.class);
     ...
     * @return the request
     */
    public Save save(com.sporthorsetech.www.horseApi.model.Horse content) throws java.io.IOException {
      Save result = new Save(content);
      initialize(result);
      return result;
    }

    public class Save extends HorseApiRequest<com.sporthorsetech.www.horseApi.model.Horse> {
       ...
       * @since 1.13
       */
      protected Save(com.sporthorsetech.www.horseApi.model.Horse content) {
        super(HorseApi.this, "POST", REST_PATH, content, com.sporthorsetech.www.horseApi.model.Horse.class);
      }
     ...
     * @return the request
     */
    public Update update(com.sporthorsetech.www.horseApi.model.Horse content) throws java.io.IOException {
      Update result = new Update(content);
      initialize(result);
      return result;
    }

    public class Update extends HorseApiRequest<com.sporthorsetech.www.horseApi.model.Horse> {
       ...
       * @since 1.13
       */
      protected Update(com.sporthorsetech.www.horseApi.model.Horse content) {
        super(HorseApi.this, "PUT", REST_PATH, content, com.sporthorsetech.www.horseApi.model.Horse.class);
      }
    ...
    public class By {
      ...
      public class Id extends HorseApiRequest<com.sporthorsetech.www.horseApi.model.Horse> {
  ...
  public class Horses {
    ...
    public class List extends HorseApiRequest<com.sporthorsetech.www.horseApi.model.CollectionResponseHorse> {
       ...
       */
      protected List() {
        super(HorseApi.this, "GET", REST_PATH, null, com.sporthorsetech.www.horseApi.model.CollectionResponseHorse.class);
      }
