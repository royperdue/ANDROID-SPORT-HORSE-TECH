...
public class HorseApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "insertHorses".
   *
   * This request holds the parameters needed by the horseApi server.  After setting any optional
   * parameters, call the {@link InsertHorses#execute()} method to invoke the remote operation.
   *
   * @param ownerEmail
   * @param content the {@link com.sporthorsetech.www.horseApi.model.Horses}
   * @return the request
   */
  public InsertHorses insertHorses(java.lang.String ownerEmail, com.sporthorsetech.www.horseApi.model.Horses content) throws java.io.IOException {
    InsertHorses result = new InsertHorses(ownerEmail, content);
    initialize(result);
    return result;
  }

  public class InsertHorses extends HorseApiRequest<Void> {

    private static final String REST_PATH = "horses";

    /**
     * Create a request for the method "insertHorses".
     *
     * This request holds the parameters needed by the the horseApi server.  After setting any
     * optional parameters, call the {@link InsertHorses#execute()} method to invoke the remote
     * operation. <p> {@link
     * InsertHorses#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param ownerEmail
     * @param content the {@link com.sporthorsetech.www.horseApi.model.Horses}
     * @since 1.13
     */
    protected InsertHorses(java.lang.String ownerEmail, com.sporthorsetech.www.horseApi.model.Horses content) {
      super(HorseApi.this, "POST", REST_PATH, content, Void.class);
      this.ownerEmail = com.google.api.client.util.Preconditions.checkNotNull(ownerEmail, "Required parameter ownerEmail must be specified.");
    }

    @Override
    public InsertHorses setAlt(java.lang.String alt) {
      return (InsertHorses) super.setAlt(alt);
    }

    @Override
    public InsertHorses setFields(java.lang.String fields) {
      return (InsertHorses) super.setFields(fields);
    }

    @Override
    public InsertHorses setKey(java.lang.String key) {
      return (InsertHorses) super.setKey(key);
    }

    @Override
    public InsertHorses setOauthToken(java.lang.String oauthToken) {
      return (InsertHorses) super.setOauthToken(oauthToken);
    }

    @Override
    public InsertHorses setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (InsertHorses) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public InsertHorses setQuotaUser(java.lang.String quotaUser) {
      return (InsertHorses) super.setQuotaUser(quotaUser);
    }

    @Override
    public InsertHorses setUserIp(java.lang.String userIp) {
      return (InsertHorses) super.setUserIp(userIp);
    }
    ...
    public InsertHorses setOwnerEmail(java.lang.String ownerEmail) {
      this.ownerEmail = ownerEmail;
      return this;
    }

    @Override
    public InsertHorses set(String parameterName, Object value) {
      return (InsertHorses) super.set(parameterName, value);
    }
  }
